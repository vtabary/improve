export const CATEGORIES = [
  {
    ...
    source: 'https://www.improticket.com/categories',
  },
  {
    label: 'Accessoire',
    description:
  ...
  {
    label: 'Buzzer, ou changement de direction',
    description:
  ...
  {
    label: "Intervention de l'arbitre",
    description:
  ...
  {
    label: "Intervention de l'arbitre avec Choix du public",
    description:
  ...
  {
    label: 'Sous-titres, ou doublage étranger',
    description:
  ...
  {
    label: 'Suspens et grands frissons',
    description:
